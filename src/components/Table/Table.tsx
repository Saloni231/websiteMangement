          ...
          {paginatedData.length === 0 ? (
            ...
            paginatedData.map((item, index) => {
              ...
              if (item.categories) {
                ...
                if (item.categories.length > 5) {
                  otherCategories = `${item.categories
                    .slice(1, 6)
                    .join(", ")} <span class="text-[#613FDD] font-semibold">+${
              ...
              const isCrypto =
                ...
                item.offers?.greyNicheOffer?.categories?.Crypto?.guestPost >
                  0 &&
                item.offers?.greyNicheOffer?.categories?.Crypto?.linkInsertion >
                  0;
              const isLoan =
                item.offers?.greyNicheOffer?.categories?.Loan?.guestPost &&
                item.offers?.greyNicheOffer?.categories?.Loan?.linkInsertion &&
                item.offers?.greyNicheOffer?.categories?.Loan?.guestPost > 0 &&
                item.offers?.greyNicheOffer?.categories?.Loan?.linkInsertion >
                  0;
              const isAdult =
                item.offers?.greyNicheOffer?.categories?.Adult?.guestPost &&
                item.offers?.greyNicheOffer?.categories?.Adult?.linkInsertion &&
                item.offers?.greyNicheOffer?.categories?.Adult?.guestPost > 0 &&
                item.offers?.greyNicheOffer?.categories?.Adult?.linkInsertion >
                  0;
              const isPharmacy =
              ...
              const isCBD =
                ...
                item.offers?.greyNicheOffer?.categories?.CBD?.linkInsertion > 0;
