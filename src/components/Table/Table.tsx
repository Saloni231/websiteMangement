      ...
      <Table className="min-w-ful  border-collapse shadow-md rounded-lg overflow-hidden">
        <TableHeader>
          <TableRow className="bg-[#613FDD05]">
            <TableCell className="px-6 py-3 text-sm font-semibold text-left text-[#0F0C1B99]">
              Website
            </TableCell>
            <TableCell className="px-6 py-3 text-sm font-semibold text-left text-[#0F0C1B99]">
              Country
        ...
        <TableBody>
          {paginatedData.map((item, index) => {
            ...
            return (
              ...
              >
                <TableCell className="px-6 py-3 text-sm text-[#0F0C1B] text-[13px]">
                  {getDomainFromUrl(item.website)}
                </TableCell>
                <TableCell className="px-6 py-3 text-sm text-[#0F0C1B] text-[13px]">
                  <div className="flex items-center gap-2">
                    <Image src={item.flag} alt="flag" width={20} height={15} />{" "}
                    {item.country}
                  </div>
                </TableCell>
                <TableCell className="px-6 py-3 text-sm text-[#0F0C1B] text-[13px]">
                ...
                <TableCell className="px-6 py-3 text-sm text-[#0F0C1B] text-[13px]">
                  <span
                    dangerouslySetInnerHTML={{ __html: otherCategories || "-" }}
                  />
                </TableCell>
                <TableCell>
